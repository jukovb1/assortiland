...
if (empty($_POST)){
    ...
    if (!isset($_POST['area'])){
        ...
        if ($_cur_area=='comments'){
            $area_path=$_SERVER['DOCUMENT_ROOT']."/modules/system/comments/comments_c.ajax.php";
            ...
            $area_path=$_SERVER['DOCUMENT_ROOT']."/modules/$_cur_area/".$_cur_area."_c.ajax.php";
            require_once($area_path);
        }
    }
}
