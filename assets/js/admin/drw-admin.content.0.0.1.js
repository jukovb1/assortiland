...
$(document).ready(function($) {
    ...
    $('button:submit').click(function(){
        ...
        if (empty($('#cont_files_2').val())==false && $('#cont_files_2').val()!=" "){
            $('#cont_files').removeAttr('required').removeAttr('name');
        } else {
            $('#cont_files').attr('required','required').attr('name','cont_files');
        }
        if (empty($('#cont_files').val())==false){
            $('#cont_files_2').removeAttr('required').removeAttr('name').val('');
        } else {
            $('#cont_files_2').attr('required','required').attr('name','cont_files');
        }
